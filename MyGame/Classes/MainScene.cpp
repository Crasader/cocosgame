...
bool MainScene::init()
{
    ...
    for (int i=0; i < vChapters.size(); i++)
    {
        ...
        auto itemLabel = LabelTTF::create(vChapters.at(i), "Arial", 48);
    ...
    vMenuItems.at(0)->setCallback([&](cocos2d::Ref *sender) {
        Director::getInstance()->pushScene(Chapter2::createScene());
    });
    vMenuItems.at(1)->setCallback([&](cocos2d::Ref *sender) {
        Director::getInstance()->pushScene(Chapter3::createScene());
    });
    vMenuItems.at(2)->setCallback([&](cocos2d::Ref *sender) {
        Director::getInstance()->pushScene(Chapter4::createScene());
    });
    vMenuItems.at(3)->setCallback([&](cocos2d::Ref *sender) {
        auto chapter5 = Chapter5();
        Director::getInstance()->pushScene(chapter5.getScene1());
    });
    vMenuItems.at(4)->setCallback([&](cocos2d::Ref *sender) {
        Director::getInstance()->pushScene(Chapter6::createScene());
    });
    vMenuItems.at(5)->setCallback([&](cocos2d::Ref *sender) {
        Director::getInstance()->pushScene(Chapter7::createScene());
    });
    vMenuItems.at(6)->setCallback([&](cocos2d::Ref *sender) {
        Director::getInstance()->pushScene(Chapter9::createScene());
    });
    vMenuItems.at(7)->setCallback([&](cocos2d::Ref *sender) {
        Director::getInstance()->pushScene(Chapter12::createScene());
    });
    vMenuItems.at(8)->setCallback([&](cocos2d::Ref *sender) {
        Director::getInstance()->pushScene(Chapter13::createScene());
    });
    ...
    listener->onKeyReleased = CC_CALLBACK_2(MainScene::onKeyboardReleased, this);
...
void MainScene::onKeyboardReleased(EventKeyboard::KeyCode keycode, Event* ev)
{
    log("released, keycode:%d", keycode);
